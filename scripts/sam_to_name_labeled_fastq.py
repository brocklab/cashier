...
#### print fastq format output if cell and umi is assigned

	if cell_barcode and umi: 
		#print read name, seq, comment, quality 
		print "@{}_{}_{}".format(record.query_name, umi, cell_barcode)
		print record.query_sequence
		print '+'
		qualities = record.query_qualities 
		ascii_qualities = ''.join([chr(q+33) for q in qualities])
		print ascii_qualities
